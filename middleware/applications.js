import applicationSchema from '../schemas/applications.js';
import ApiError from '../errors/errors.js';

/**
 * Middleware to validate application data using Yup schema
...
export const validateApplication = async (req, res, next) => {
  try {
    // Validate the request body against the application schema
    const validatedData = await applicationSchema.validate(req.body, {
...
/**
 * Middleware to validate application update data (partial validation)
...
export const validateApplicationUpdate = async (req, res, next) => {
  try {
    ...
    const partialSchema = applicationSchema.partial();
