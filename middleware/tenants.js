import tenantSchema from '../schemas/tenants.js';
import ApiError from '../errors/errors.js';

/**
 * Middleware to validate tenant data using Yup schema
...
export const validateTenant = async (req, res, next) => {
  try {
    // Validate the request body against the tenant schema
    const validatedData = await tenantSchema.validate(req.body, {
...
/**
 * Middleware to validate tenant update data (partial validation)
 * This allows partial updates where not all fields are required
 * @param {Object} req - Express request object
 * @param {Object} res - Express response object
 * @param {Function} next - Express next function
 */
export const validateTenantUpdate = async (req, res, next) => {
  try {
...
/**
 * Middleware to validate tenant ID parameter
 * @param {Object} req - Express request object
 * @param {Object} res - Express response object
 * @param {Function} next - Express next function
 */
